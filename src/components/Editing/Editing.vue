        ...
        <div class="richText">
          ...
          >
            ...
            <el-form-item label="试看内容" prop="delivery" required>
              <RichText v-model="text"></RichText>
            </el-form-item>
            <el-form-item label="课程内容" prop="delivery" required>
              <RichText v-model="course"></RichText>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    parentHandleclick(text) {
      this.dialogVisible = true;
      console.log(text)
      this.ruleForm.name = text.title
      this.text = text.content
      this.course = text.try
      this.num = text.price
      this.ruleForm.radio = text.status
    },
    handleAvatarSuccess() {},
    beforeAvatarUpload() {},
    handleChange() {},
